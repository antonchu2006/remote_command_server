...
#define SERV_HOST_ADDR "192.168.0.18"     /* IP, only IPV4 support  */
        ...
        {              
            ...
            {  
                ...
                else
                {
                    ...
                    fp = popen(buff_rx, "r");
                    if (fp == NULL) {
                        char *buff_tx = "Failed to run command\n";
                        exit(1);
                    }

                    /* Read the output a line at a time - output it. */
                    while (fgets(buff_tx, sizeof(buff_tx), fp) != NULL) {
